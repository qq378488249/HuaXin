 ...
 * hcl
 */
public class TjxxActivity extends BaseActivity {
    ...
    ArrayList<Allergy> list_fy = new ArrayList<Allergy>();
    ArrayList<Allergy> list_fy_select = new ArrayList<Allergy>();
    //初始数据
    ArrayList<Allergy> list_fy_init = new ArrayList<Allergy>();
    ...
    TagFlowLayout fl;
    void show_fy() {
//        ArrayList<Allergy> list_fy_select = new ArrayList<>();
//        list_fy_select.clone();
//        list_fy_init.clone();
        list_fy_select.clear();
        for (Allergy allergy : list_fy) {
            Allergy a = new Allergy(allergy.getIs_select(),allergy.getTitle());
            list_fy_select.add(a);
        }
//        list_fy_select.clear();
//        for (Allergy allergy : list_fy) {
//            list_fy_select.add(allergy);
//        }
//        list_fy_select.addAll(list_fy);
        ...
        if (dialog_fy == null) {
            ...
            fl = (TagFlowLayout) dialog_fy.findViewById(R.id.fl);
            fl.setOnTagClickListener(new TagFlowLayout.OnTagClickListener() {
                @Override
                public boolean onTagClick(View view, int position, FlowLayout parent) {
//                    toask(list_jj.get(position).getName());
                    if (list_fy_select.get(position).getIs_select() != null && list_fy_select.get(position).getIs_select().equals("1")) {
                        list_fy_select.get(position).setIs_select("0");
                    } else {
                        list_fy_select.get(position).setIs_select("1");
                    }
            ...
            dialog_fy.setOnDismissListener(new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialogInterface) {
                    ...
                    for (int i = 0; i < list_fy_select.size(); i++) {
                        if (list_fy_select.get(i).getIs_select() != null && list_fy_select.get(i).getIs_select().equals("1"))
                            count1++;
                    }
                    if (count < 1) {
                    ...
                    System.out.println(list_fy_select.toString());
                    System.out.println(list_fy.toString());
        ...
        dialog_fy.findViewById(R.id.tv_yes).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < list_fy_select.size(); i++) {
                    if (list_fy_select.get(i).getIs_select() != null && list_fy_select.get(i).getIs_select().equals("1")) {
                        if (batch_id.equals("")) {
                            batch_id += "" + list_fy_select.get(i).getTitle();
                        } else {
                            batch_id += "," + list_fy_select.get(i).getTitle();
                        }
//                            list_delete.add(list_fy_select.get(i));
                    }
                }
