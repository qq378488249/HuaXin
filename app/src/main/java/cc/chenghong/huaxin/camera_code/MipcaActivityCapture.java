...
import cc.chenghong.huaxin.activity.BaseActivity;
import cc.chenghong.huaxin.activity.BdsbActivity;
...
//        initXutils();
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            ...
            Intent intent = new Intent(getApplication(),BdsbActivity.class);
            intent.putExtra("data",resultString);
            setResult(RESULT_OK, intent);
            finish();
//            App.toask(resultString);
        }
