...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(getResources().getColor(R.color.blue_title));//选中项的字体颜色
            } else {
                itemView.setTextColor(getResources().getColor(R.color.gray));//未选中项的字体颜色
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(getResources().getColor(R.color.blue_title));
//            paint.setColor(Color.parseColor("#83cde6"));//间隔线颜色
